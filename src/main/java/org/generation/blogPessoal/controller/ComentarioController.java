...
public class ComentarioController {
    ...
    public ResponseEntity<Comentario> put(@RequestBody Comentario comentarios) {
		if (usuarioRepository.existsById(comentarios.getUsuario().getId())
				&& postagemRepository.existsById(comentarios.getPostagem().getId())) {
			return ResponseEntity.status(HttpStatus.OK).body(comentarioRepository.save(comentarios));
		}
	...
	public void delete(@PathVariable long id) {
		Optional<Comentario> post = comentarioRepository.findById(id);
